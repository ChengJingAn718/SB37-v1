...
let repeatAudio = new loadSound('dragSound', true);
...
let bubbleAudio = new loadSound('bubble', true);
...
export default function BaseShot() {
    ...
    function setBackground(imgUrl, optionNum = -1, backState = 1) {
        if (imgUrl != oldBackgroundImage) {
            ...
            myImage1.current.src = prePathUrl() + "images/SB_37_BG/" + imgUrl + ".svg";
            setSuitableBackground(backState);

            setTimeout(() => {
                myImage.current.src = prePathUrl() + "images/SB_37_BG/" + imgUrl + ".svg";
    ...
    return (
        <div style={
            ...
            { /* <iframe src={prePathUrl() + "sounds/effect/silence.mp3"} allow="autoplay" id="audio" style={{ display: "none" }}></iframe> */}
            ...
            <div ref={imageBack}
                ...
                <img draggable={false}
                    height={"100%"}
                    ref={myImage}
                    src={prePathUrl() + "images/SB_37_BG/SB_37_Stage_BG_2.svg"}
                />
            </div>
            <div ref={imageBack1}
                style={
