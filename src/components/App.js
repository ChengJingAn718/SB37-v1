    ...
    <div >
      <div className={_isBackloaded ? 'aniObject' : 'hideObject'}>
        <Switch test={index}>
          ...
          <Scene3 nextFunc={nextFunc} gameNumber={0} _baseGeo={baseGeo} _geo={__geo} value={2} />
          <WellDone nextFunc={nextFunc} _baseGeo={baseGeo} _geo={__geo} value={3} />
          <Scene4 nextFunc={nextFunc} _startTransition={_startTransition} gameNumber={0} _baseGeo={baseGeo} _geo={__geo} value={4} />
