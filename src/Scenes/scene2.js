...
import { returnAudioPath, blinkFunc, stopBlinkFunc } from '../components/CommonFunctions';
...
const Scene1 = React.forwardRef(({ nextFunc, _baseGeo, _geo, _startTransition }, ref) => {
    ...
    const introAudioList = ['14', '11', '69', '59', '48', '60', '70']
    ...
    function changePicture() {
        if (backgroundList[pictureShowingCount] != backgroundList[pictureShowingCount + 1]
            && pictureShowingCount < backgroundList.length - 1)
            changeCart();
                        ...
                        timerList[4] = setTimeout(() => {
                            ...
                            timerList[5] = setTimeout(() => {
                                ...
                                timerList[6] = setTimeout(() => {
                                    setAppearState(introBoyOrderList[0])
                                    audioList.bodyAudio1.play().catch(error => { });
        ...
        if (pictureInfoList.length - 1 > pictureShowingCount) {
            ...
            timerList[11] = setTimeout(() => {
                ...
                timerList[12] = setTimeout(() => {
                    setAppearState(2)
                    audioList.bodyAudio3.play().catch(error => { });
                    timerList[13] = setTimeout(() => {
                        setAppearState()

                        timerList[14] = setTimeout(() => {
                            _startTransition(3)
                            timerList[15] = setTimeout(() => {
        ...
        <div ref={baseObject} className='hideObject'>
            <div >
                ...
                <div
                    ...
                    <BaseImage
                        ref={introPanel1}
                        url={"SB_37_FG/SB_37_FG_Cutout_Land_1.svg"}
                    />
                    ...
                    <BaseImage
                        ...
                        posInfo={{ l: 0.3, t: 0.8 }}
                        url={"SB_37_Character-Interactive/SB_37_CI_Tiger_1.svg"}
                    />
                    <BaseImage
                        ref={introAnimal1}
                        scale={0.55}
                        posInfo={{ l: 0.25, t: 0.8 }}
                        url={"SB_37_Character-Interactive/SB_37_CI_Lion_1.svg"}
                    />
